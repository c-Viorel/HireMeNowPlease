<x-app-layout>
    ...
    <div class="py-10">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('employer.companies.update', $company) }}" enctype="multipart/form-data" class="bg-white shadow-sm sm:rounded-lg">
                @csrf
                @method('PATCH')
                ...
                <div class="space-y-6 p-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="5" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description', $company->description) }}</textarea>
