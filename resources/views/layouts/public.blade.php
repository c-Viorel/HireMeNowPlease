    ...
    <body class="bg-slate-50 font-sans text-slate-950 antialiased">
        <div class="min-h-screen">
            <header class="sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur">
                <nav class="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-4 py-3 sm:h-16 sm:flex-nowrap sm:px-6 sm:py-0 lg:px-8" aria-label="Navigatie publica">
                    ...
                    <div class="flex w-full flex-wrap items-center gap-1.5 text-sm font-semibold min-[420px]:w-auto min-[420px]:justify-end sm:gap-3">
